...
class Poland implements \Pd\Holidays\ILocalization
{
	...
	public function getHolidays(int $year): \Pd\Holidays\IYear
	{
		...
		$holidays[] = $this->holidayFactory->create(1, 6, '_label_holiday_01_06');
		$holidays[] = $this->holidayFactory->create(5, 1, '_label_holiday_05_01');
		$holidays[] = $this->holidayFactory->create(5, 3, '_label_holiday_05_03');
		...
		$holidays[] = $this->createHoliday($easter->modify('+60 day'), '_label_holiday_corpus_christi');
